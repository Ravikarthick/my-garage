...
export const MANUFACTURERS = [
  ...
  'Gordon Murray','Czinger','Rimac','Hennessey','Apollo','Zenvo','Pininfarina','Donkervoort','Caterham','Morgan','TVR','Noble','Ariel','W Motors','Abarth','Opel','Holden','Mitsuoka','Alpine','Cupra','VinFast','Fisker','Karma','Hispano Suiza','Maybach','Spyker','Ultima','Gumpert','Radford','MAN','Scania','Wiesmann','Donut','RUF',
  'Unknown',
].sort();
