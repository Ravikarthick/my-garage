...
const styles = StyleSheet.create({
  outer: { padding: 8 },
  frame: { borderWidth: 2, borderRadius: 16, padding: 10, backgroundColor: '#1C1C1E', position: 'relative' },
  inner: { borderRadius: 8, overflow: 'hidden', backgroundColor: '#101012' },
  ...
  stamp: { position: 'absolute', bottom: 16, right: 16, backgroundColor: 'rgba(20,20,22,0.85)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
